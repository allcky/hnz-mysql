 ...
 * @return object
 */
mysqlvi.prototype.t = function(table){
	this.table = table;
	return this;
}
 ...
 * @return object
 */
mysqlvi.prototype.f = function(field){
	this.field = field;
	return this;
}
 ...
 * @return object
 */
mysqlvi.prototype.data = function(data){
	this.Data = data;
	return this;
}
 ...
 * @return object
 */
mysqlvi.prototype.o = function(order,type='asc'){
 ...
 * @return object
 */
mysqlvi.prototype.l = function(offset,num){
	if(num){
 ...
 * @return object
 */
mysqlvi.prototype.w = function(data){
	for(var i in data){
		this.where = ' where '+i+'='+data[i]+' ';
	}
	return this;
}
mysqlvi.prototype.g = function(field){
 ...
 * @return undefined
 */
mysqlvi.prototype.s = function(callback){
 ...
 * @return undefined
 */
mysqlvi.prototype.u = function(callback){
	var table = this.table;
	var where = this.where;
	var data = this.Data;
	var str = "";
	...
	str = str.slice(0,-1);
	console.log("update "+table+" set "+str+where)
 ...
 * @return undefined
 */
mysqlvi.prototype.i = function(callback){
	var table = this.table;
	var data = this.Data;
	var attr = "(";
	var str = "(";
 ...
 * @return undefined
 */
mysqlvi.prototype.d = function(callback){
	var table = this.table;
	var where = this.where;
 ...
 * @return undefined
 */
mysqlvi.prototype.query = function(){
	this.pool.query(...arguments);
};

module.exports = mysqlvi;